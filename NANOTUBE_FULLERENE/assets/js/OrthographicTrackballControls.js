 ...
 *	Souris toute buggée, events sur la wheel enlevés
 */
...
THREE.OrthographicTrackballControls = function ( object, domElement ) {
	...
	this.zoomCamera = function () {
		...
		if(_this.object.zoom < 0.5)
		{
			_this.object.zoom =0.5;
		}
		if(_this.object.zoom > 1.5)
		{
			_this.object.zoom = 1.5;
		}
	...
	function mousewheel( event ) {
		...
		_zoomStart.y -= event.deltaY* 0.0001;
		_this.dispatchEvent( startEvent );
		_this.dispatchEvent( endEvent );
